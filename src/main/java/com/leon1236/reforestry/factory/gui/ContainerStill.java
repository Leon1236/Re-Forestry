...
public class ContainerStill extends ContainerMachine<TileStill> implements IContainerLiquidTanks, IContainerRecipeBook {
    ...
    public List<MachineRecipeEntry> getGuiRecipes() {
        ...
        return MachineGuiRecipes.still(level);
    }
