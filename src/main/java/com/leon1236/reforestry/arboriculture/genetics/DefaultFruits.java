...
public final class DefaultFruits {
    ...
    public static final IFruit COCOA = new PodFruit(ReForestry.id("fruit_cocoa"), false, ForestryPodType.COCOA,
    ...
    public static final IFruit DATES = new PodFruit(ReForestry.id("fruit_dates"), false, ForestryPodType.DATES,
            List.of(new IFruit.Product(CoreItems.FRUITS.get(EnumFruit.DATES).item(), 1.0f)));
    public static final IFruit PAPAYA = new PodFruit(ReForestry.id("fruit_papaya"), false, ForestryPodType.PAPAYA,
    ...
    public static final IFruit COCONUT = new PodFruit(ReForestry.id("fruit_coconut"), false, ForestryPodType.COCONUT,
