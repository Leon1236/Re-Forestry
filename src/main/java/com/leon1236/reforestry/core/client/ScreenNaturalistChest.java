...
public class ScreenNaturalistChest extends ScreenForestry<ContainerNaturalistChest> {
	...
	public ScreenNaturalistChest(ContainerNaturalistChest menu, Inventory inventory, Component title) {
		super(menu, inventory, title, IMAGE_WIDTH, IMAGE_HEIGHT);
		this.inventoryLabelY = NaturalistInventoryLayout.PLAYER_INV_Y - 11;
		setHintKey("naturalist.chest");
	}
