...
public class ExtraTreesBoatRenderer<T extends AbstractBoat & IExtraTreesBoat> extends EntityRenderer<T, ExtraTreesBoatRenderer.ExtraTreesBoatRenderState> {
	public static final ModelLayerLocation BOAT_MODEL_LAYER = new ModelLayerLocation(ReForestry.id("extra_tree_boat"), "main");
	public static final ModelLayerLocation CHEST_BOAT_MODEL_LAYER = new ModelLayerLocation(ReForestry.id("extra_tree_chest_boat"), "main");

	private final Model.Simple waterPatchModel;
	private final EntityModel<BoatRenderState> model;
	private final EnumMap<ExtraTreeWoodType, Identifier> textures;

	public ExtraTreesBoatRenderer(EntityRendererProvider.Context context, boolean hasChest) {
		super(context);
		...
		this.textures = new EnumMap<>(ExtraTreeWoodType.class);
	...
	@Override
	public void submit(ExtraTreesBoatRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState camera) {
		poseStack.pushPose();
	...
	@Override
	public ExtraTreesBoatRenderState createRenderState() {
		return new ExtraTreesBoatRenderState();
	}

	@Override
	public void extractRenderState(T entity, ExtraTreesBoatRenderState state, float partialTicks) {
	...
	@Environment(EnvType.CLIENT)
	public static class ExtraTreesBoatRenderState extends BoatRenderState {
