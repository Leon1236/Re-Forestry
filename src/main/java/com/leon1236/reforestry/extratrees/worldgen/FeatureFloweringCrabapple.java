...
public class FeatureFloweringCrabapple extends FeatureBinnieTree {
	public FeatureFloweringCrabapple(ITreeGenData tree) {
		super(tree, 3, 6);
	}
	...
	protected void generateLeaves(IGenome genome, LevelAccessor level, RandomSource rand, TreeBlockTypeLeaf leaf, TreeContour contour, BlockPos startPos) {
		...
		while(leafSpawn > 3) {
			generateCylinder(level, rand, leaf, contour, startPos, 0, leafSpawn--, 0, this.girth + 3);
		}
