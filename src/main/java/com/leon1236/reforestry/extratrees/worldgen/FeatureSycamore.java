...
public class FeatureSycamore extends FeatureBinnieTree {
	public FeatureSycamore(ITreeGenData tree) {
		super(tree, 6, 2);
	}
	...
	protected void generateLeaves(IGenome genome, LevelAccessor level, RandomSource rand, TreeBlockTypeLeaf leaf, TreeContour contour, BlockPos startPos) {
		...
		generateCylinder(level, rand, leaf, contour, startPos, 0.0f, leafSpawn--, 0.0f, width - 1.3f);
