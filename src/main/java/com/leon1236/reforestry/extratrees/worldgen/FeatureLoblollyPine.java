...
public class FeatureLoblollyPine extends FeatureBinnieTree {
	public FeatureLoblollyPine(ITreeGenData tree) {
		super(tree, 6, 2);
	}
	...
	protected void generateLeaves(IGenome genome, LevelAccessor level, RandomSource rand, TreeBlockTypeLeaf leaf, TreeContour contour, BlockPos startPos) {
		...
		final float bottom = this.height * randBetween(rand, 0.65f, 0.7f);
