...
public class FeatureOsangeOrange extends FeatureBinnieTree {
	public FeatureOsangeOrange(ITreeGenData tree) {
		super(tree, 5, 1);
	}
	...
	protected void generateLeaves(IGenome genome, LevelAccessor level, RandomSource rand, TreeBlockTypeLeaf leaf, TreeContour contour, BlockPos startPos) {
		...
		float width = this.height * randBetween(rand, 0.2f, 0.25f);
		if (width < 2.0f) {
			width = 2.0f;
		}
