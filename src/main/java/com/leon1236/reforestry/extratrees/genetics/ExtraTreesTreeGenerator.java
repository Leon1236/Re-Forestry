...
public final class ExtraTreesTreeGenerator implements ITreeGenerator {
	private final Function<ITreeGenData, Feature<NoneFeatureConfiguration>> factory;
	private final IWoodType woodType;

	public ExtraTreesTreeGenerator(IWoodType woodType) {
		this(FeatureTreeVanilla::new, woodType);
	}

	public ExtraTreesTreeGenerator(Function<ITreeGenData, Feature<NoneFeatureConfiguration>> factory, IWoodType woodType) {
