...
public class ScreenAlvearyFrame extends AbstractContainerScreen<ContainerAlvearyFrame> {
	private static final Identifier TEXTURE = ReForestry.id("textures/gui/alveary_frame.png");
	private static final int IMAGE_WIDTH = 176;
	private static final int IMAGE_HEIGHT = 144;

	public ScreenAlvearyFrame(ContainerAlvearyFrame menu, Inventory inventory, Component title) {
