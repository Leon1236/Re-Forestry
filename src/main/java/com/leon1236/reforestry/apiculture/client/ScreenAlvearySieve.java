...
public class ScreenAlvearySieve extends AbstractContainerScreen<ContainerAlvearySieve> {
    private static final Identifier TEXTURE = ReForestry.id("textures/gui/sieve.png");
    private static final int IMAGE_WIDTH = 176;
    private static final int IMAGE_HEIGHT = 169;

    public ScreenAlvearySieve(ContainerAlvearySieve menu, Inventory inventory, Component title) {
