...
public class CrateItems {
	...
	public static final FeatureItem<ItemCrated> CRATE = REGISTRY.item("crate", properties -> new ItemCrated(() -> ItemStack.EMPTY, properties));

	public static final FeatureItem<ItemCrated> CRATED_PEAT = register(CoreItems.PEAT.item(), "crated_peat");
	public static final FeatureItem<ItemCrated> CRATED_APATITE = register(CoreItems.APATITE.item(), "crated_apatite");
	public static final FeatureItem<ItemCrated> CRATED_FERTILIZER_COMPOUND = register(CoreItems.FERTILIZER_COMPOUND.item(), "crated_fertilizer_compound");
	public static final FeatureItem<ItemCrated> CRATED_MULCH = register(CoreItems.MULCH.item(), "crated_mulch");
	public static final FeatureItem<ItemCrated> CRATED_PHOSPHOR = register(CoreItems.CRAFTING_MATERIALS.item(EnumCraftingMaterial.PHOSPHOR), "crated_phosphor");
	public static final FeatureItem<ItemCrated> CRATED_ASH = register(CoreItems.ASH.item(), "crated_ash");
	public static final FeatureItem<ItemCrated> CRATED_TIN = register(CoreItems.INGOT_TIN.item(), "crated_tin");
	public static final FeatureItem<ItemCrated> CRATED_COPPER = register(Items.COPPER_INGOT, "crated_copper");
	public static final FeatureItem<ItemCrated> CRATED_BRONZE = register(CoreItems.INGOT_BRONZE.item(), "crated_bronze");
	public static final FeatureItem<ItemCrated> CRATED_HUMUS = register(java.util.Objects.requireNonNull(CoreBlocks.HUMUS.item()), "crated_humus");
	public static final FeatureItem<ItemCrated> CRATED_BOG_EARTH = register(java.util.Objects.requireNonNull(CoreBlocks.BOG_EARTH.item()), "crated_bog_earth");
	...
	public static final FeatureItem<ItemCrated> CRATED_BEESWAX = register(CoreItems.BEESWAX.item(), "crated_beeswax");
	public static final FeatureItem<ItemCrated> CRATED_REFRACTORY_WAX = register(CoreItems.REFRACTORY_WAX.item(), "crated_refractory_wax");
	...
	private static FeatureItem<ItemCrated> register(ItemLike contained, String identifier) {
		FeatureItem<ItemCrated> item = REGISTRY.item(identifier, properties -> new ItemCrated(() -> new ItemStack(contained), properties));
		CRATES.add(item);
		return item;
	}
