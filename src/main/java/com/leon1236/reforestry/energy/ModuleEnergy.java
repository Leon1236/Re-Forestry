...
public class ModuleEnergy implements IForestryModule {
    ...
    private static void setupApi() {
        FuelManager.biogasEngineFuel = new HashMap<>();
        FuelManager.peatEngineFuel = new HashMap<>();
        ...
        FuelManager.peatEngineFuel.put(peat, new EngineCopperFuel(peat,
        ...
        FuelManager.peatEngineFuel.put(bituminousPeat, new EngineCopperFuel(bituminousPeat,
