...
Sources:
  models/blockstates (structurally unchanged since 1.20.1, only need the
           ...
           the latest frozen CE 1.20.1 clone (tools/ce_paths.py)
  recipes/loot tables/tags (also datagen output) - same root.
  textures (static PNGs, never datagen output) come from CE's own
           src/main/resources: the latest frozen CE 1.20.1 clone (tools/ce_paths.py)
...
from ce_paths import rel as _ce_rel, generated as _ce_generated, main_resources as _ce_main
