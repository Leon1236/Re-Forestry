# thedarkcolour-ForestryCE — cultivation
...
## Summary
Module `cultivation` in `thedarkcolour-ForestryCE` is rooted at `src/main/java/forestry/cultivation` (30 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py CE "cultivation"`
...
- Declaration skim (first files):
  ...
  - `src/main/java/forestry/cultivation/ModuleCultivation.java`
    - L1: package forestry.cultivation;
    - L13: @ForestryModule
    - L14: public class ModuleCultivation extends BlankForestryModule {
    - L15: @Override
    - L16: public ResourceLocation getId() {
    - L20: @Override
    - L21: public void registerClientHandler(Consumer<IClientModuleHandler> registrar) {
    - L25: @Override
    - L26: public List<ResourceLocation> getModuleDependencies() {
  - `src/main/java/forestry/cultivation/blocks/BlockPlanter.java`
    ...
    - L24: @Override
    - L25: public BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
