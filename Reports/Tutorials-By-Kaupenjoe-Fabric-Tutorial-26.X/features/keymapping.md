# Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X — keymapping
...
- Package/path root: `src/main/java/net/kaupenjoe/tutorialmod/keymapping`
- Java files scanned: **1**
- Date: 2026-07-30

## Summary
Module `keymapping` in `Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X` is rooted at `src/main/java/net/kaupenjoe/tutorialmod/keymapping` (1 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py kaupenjoe "keymapping"`
- Source root exists: **True**
- Declaration skim (first files):
  - `src/main/java/net/kaupenjoe/tutorialmod/keymapping/ModKeyMappings.java`
    - L1: package net.kaupenjoe.tutorialmod.keymapping;
    - L9: public class ModKeyMappings {
    - L10: public static final KeyMapping KAUPEN_KEYMAPPING = KeyMappingHelper.registerKeyMapping(
    - L16: public static void register() {
