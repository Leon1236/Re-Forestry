# Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X — loot
...
- Package/path root: `src/main/java/net/kaupenjoe/tutorialmod/loot`
- Java files scanned: **1**
- Date: 2026-07-30

## Summary
Module `loot` in `Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X` is rooted at `src/main/java/net/kaupenjoe/tutorialmod/loot` (1 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py kaupenjoe "loot"`
- Source root exists: **True**
- Declaration skim (first files):
  - `src/main/java/net/kaupenjoe/tutorialmod/loot/ModLootTableModifiers.java`
    - L1: package net.kaupenjoe.tutorialmod.loot;
    - L18: public class ModLootTableModifiers {
    - L19: public static void modifyLootTables(ResourceKey<LootTable> key, FabricLootTableBuilder builder,
...
- Mentions of `loot` appear in `files/implemented-features.md` — check that file for port status.
