# Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X — sounds
...
- Package/path root: `src/main/java/net/kaupenjoe/tutorialmod/sound`
- Java files scanned: **1**
- Date: 2026-07-30

## Summary
Module `sounds` in `Tutorials-By-Kaupenjoe-Fabric-Tutorial-26.X` is rooted at `src/main/java/net/kaupenjoe/tutorialmod/sound` (1 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py kaupenjoe "sounds"`
- Source root exists: **True**
- Declaration skim (first files):
  - `src/main/java/net/kaupenjoe/tutorialmod/sound/ModSounds.java`
    - L1: package net.kaupenjoe.tutorialmod.sound;
    - L10: public class ModSounds {
    - L11: public static final SoundEvent CHISEL_USE = registerSoundEvent("chisel_use");
    - L13: public static final Holder.Reference<SoundEvent> BAR_BRAWL = registerJukeboxSong("bar_brawl");
    - L27: public static void registerSounds() {
