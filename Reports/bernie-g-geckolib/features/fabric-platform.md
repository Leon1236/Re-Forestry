# bernie-g-geckolib — fabric-platform
...
- Package/path root: `fabric/src/main/java/com/geckolib`
- Java files scanned: **31**
- Date: 2026-07-30

## Summary
Module `fabric-platform` in `bernie-g-geckolib` is rooted at `fabric/src/main/java/com/geckolib` (31 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
- `GeckoLibClientFabric`
- `GeckoLibFabric`
- `package-info`

## Architecture
- Graph follow-up: `python3 tools/graphify_query.py geckolib "fabric-platform"`
...
- Nested packages under this module:
  ...
  - `event/item`
  - `event/object`
  - `event/replacedentity`
  - `network`
  - `platform`
- Declaration skim (first files):
  - `fabric/src/main/java/com/geckolib/GeckoLib.java`
    - L1: package com.geckolib;
    - L7: public final class GeckoLib implements ModInitializer {
    - L8: @Override
    - L9: public void onInitialize() {
  - `fabric/src/main/java/com/geckolib/GeckoLibClient.java`
    - L1: package com.geckolib;
    - L13: public class GeckoLibClient implements ClientModInitializer {
    - L14: @Override
    - L15: public void onInitializeClient() {
    - L19: @ApiStatus.Internal
    - L20: public static <P extends MultiloaderPacket> void registerPacket(CustomPacketPayload.Type<P> packetType) {
...
- `fabric/src/main/java/com/geckolib/platform/GeckoLibClientFabric.java`
- `fabric/src/main/java/com/geckolib/platform/GeckoLibFabric.java`
- `fabric/src/main/java/com/geckolib/platform/package-info.java`
