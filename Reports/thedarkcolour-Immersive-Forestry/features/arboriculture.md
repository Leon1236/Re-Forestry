# thedarkcolour-Immersive-Forestry — arboriculture
...
## Summary
Module `arboriculture` in `thedarkcolour-Immersive-Forestry` is rooted at `src/main/java/forestry/arboriculture` (180 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py IF "arboriculture"`
...
- Declaration skim (first files):
  ...
  - `src/main/java/forestry/arboriculture/ModuleArboriculture.java`
    ...
    - L86: @Override
    - L87: public void addToRootCommand(LiteralArgumentBuilder<CommandSourceStack> command) {
    - L105: @Override
    - L106: public void registerPackets(IPacketRegistry registry) {
    - L110: @Override
  - `src/main/java/forestry/arboriculture/ModuleCharcoal.java`
    - L1: package forestry.arboriculture;
    - L9: @ForestryModule
    - L10: public class ModuleCharcoal extends BlankForestryModule {
    - L11: @Override
    - L12: public ResourceLocation getId() {
...
- enum `SpectacleVision` in `SpectacleVision.java`
...
- `src/main/java/forestry/arboriculture/capabilities/SpectacleVision.java`
