# thedarkcolour-Immersive-Forestry — apiimpl
...
## Summary
Module `apiimpl` in `thedarkcolour-Immersive-Forestry` is rooted at `src/main/java/forestry/apiimpl` (35 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py IF "apiimpl"`
...
- Declaration skim (first files):
  ...
  - `src/main/java/forestry/apiimpl/client/plugin/ClientHelper.java`
    ...
    - L18: public class ClientHelper implements IClientHelper {
    - L19: @Override
    - L20: public ILeafTint createNoneTint() {
    - L24: @Override
    - L25: public ILeafTint createFixedTint(TextColor color) {
    - L29: @Override
    - L30: public ILeafTint createBiomeTint() {
    - L34: @Override
    - L35: public ILeafTint createBiomeTint(Int2IntFunction mapper) {
    - L37: @Override
    - L38: public int get(@Nullable BlockAndTintGetter level, @Nullable BlockPos pos) {
