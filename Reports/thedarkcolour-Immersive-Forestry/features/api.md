# thedarkcolour-Immersive-Forestry — api
...
- Java files scanned: **309**
- Date: 2026-07-30

## Summary
Module `api` in `thedarkcolour-Immersive-Forestry` is rooted at `src/main/java/forestry/api` (309 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py IF "api"`
...
- Declaration skim (first files):
  - `src/main/java/forestry/api/ForestryCapabilities.java`
    ...
    - L14: public class ForestryCapabilities {
    - L18: public static final ItemCapability<IBeeProtection, Void> BEE_PROTECTION = ItemCapability.createVoid(forestry("bee_protection"), IBeeProtection.class);
    - L23: public static final ItemCapability<ISpectacleVision, Void> SPECTACLE_VISION = ItemCapability.createVoid(forestry("spectacle_vision"), ISpectacleVision.class);
    - L28: public static final BlockCapability<IFilterLogic, Void> FILTER_LOGIC = BlockCapability.createVoid(forestry("filter_logic"), IFilterLogic.class);
  ...
  - `src/main/java/forestry/api/ForestryRegistries.java`
    - L1: package forestry.api;
    - L10: public class ForestryRegistries {
    - L11: public static final Registry<ICircuit> CIRCUIT = new RegistryBuilder<>(Keys.CIRCUIT_TYPE)
    - L15: public static final Registry<IPostalCarrier> POSTAL_CARRIER = new RegistryBuilder<>(Keys.POSTAL_CARRIER)
    - L19: public static final Registry<ISpeciesType<?, ?>> SPECIES_TYPE = new RegistryBuilder<>(Keys.SPECIES_TYPE)
    - L23: public static class Keys {
    - L24: public static final ResourceKey<Registry<ICircuit>> CIRCUIT_TYPE = ResourceKey.createRegistryKey(ForestryConstants.forestry("circuit"));
    - L25: public static final ResourceKey<Registry<IPostalCarrier>> POSTAL_CARRIER = ResourceKey.createRegistryKey(ForestryConstants.forestry("postal_carrier"));
    - L26: public static final ResourceKey<Registry<ISpeciesType<?, ?>>> SPECIES_TYPE = ResourceKey.createRegistryKey(ForestryConstants.forestry("species_type"));
  - `src/main/java/forestry/api/ForestryTags.java`
    - L1: package forestry.api;
    - L16: public class ForestryTags {
    - L17: public static class Blocks {
    - L18: public static final TagKey<Block> MINEABLE_SCOOP = blockTag("scoop");
    - L19: public static final TagKey<Block> MINEABLE_GRAFTER = blockTag("grafter");
    - L22: public static final TagKey<Block> VALID_FARM_BASE = blockTag("valid_farm_base");
    - L24: public static final TagKey<Block> CHARCOAL_BLOCK = forgeTag("storage_blocks/charcoal");
    - L26: public static final TagKey<Block> STORAGE_BLOCKS_APATITE = forgeTag("storage_blocks/apatite");
    - L27: public static final TagKey<Block> STORAGE_BLOCKS_TIN = forgeTag("storage_blocks/tin");
    - L28: public static final TagKey<Block> STORAGE_BLOCKS_BRONZE = forgeTag("storage_blocks/bronze");
    - L29: public static final TagKey<Block> STORAGE_BLOCKS_AMBER = forgeTag("storage_blocks/amber");
    - L31: public static final TagKey<Block> ORES_TIN = forgeTag("ores/tin");
...
- `src/main/resources/data/forestry/structure/village/apiarist_house_snowy_1.nbt`
- `src/main/resources/data/forestry/structure/village/apiarist_house_taiga_1.nbt`
- `src/main/resources/data/forestry/structure/village/apiarist_house_plains_1.nbt`
- `src/main/resources/data/forestry/structure/village/apiarist_house_desert_1.nbt`
- `src/main/resources/data/forestry/structure/village/apiarist_house_savanna_1.nbt`
...
- `src/main/resources/assets/forestry/textures/block/apiary.0.png`
...
- key type `ForestryRegistries` (`ForestryRegistries.java`)
...
- interface `IBeeProtection` in `IBeeProtection.java`
...
- interface `ICircuit` in `ICircuit.java`
- interface `ICircuitBoard` in `ICircuitBoard.java`
...
- `src/main/java/forestry/api/apiculture/IBeeProtection.java`
...
- `src/main/java/forestry/api/core/INbtReadable.java`
- `src/main/java/forestry/api/core/INbtWritable.java`
- `src/main/java/forestry/api/core/IProduct.java`
- `src/main/java/forestry/api/core/IProductProducer.java`
- `src/main/java/forestry/api/core/ISetupListener.java`
- … and 189 more under `src/main/java/forestry/api`
