# thedarkcolour-Immersive-Forestry — plugin
...
## Summary
Module `plugin` in `thedarkcolour-Immersive-Forestry` is rooted at `src/main/java/forestry/plugin` (15 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
## Architecture
- Graph follow-up: `python3 tools/graphify_query.py IF "plugin"`
...
- Declaration skim (first files):
  ...
  - `src/main/java/forestry/plugin/DefaultBeeSpecies.java`
    - L1: package forestry.plugin;
    - L32: public class DefaultBeeSpecies {
    - L33: @SuppressWarnings("CodeBlock2Expr")
    - L34: public static void register(IApicultureRegistration apiculture) {
  - `src/main/java/forestry/plugin/DefaultButterflySpecies.java`
    - L1: package forestry.plugin;
    - L13: public class DefaultButterflySpecies {
    - L14: @SuppressWarnings("CodeBlock2Expr")
    - L15: public static void register(ILepidopterologyRegistration butterflies) {
  ...
  - `src/main/java/forestry/plugin/DefaultForestryPlugin.java`
    - L1: package forestry.plugin;
    - L65: public class DefaultForestryPlugin implements IForestryPlugin {
    - L66: public static final ResourceLocation ID = ForestryConstants.forestry("default");
    - L68: @Override
    - L69: public void registerGenetics(IGeneticRegistration genetics) {
