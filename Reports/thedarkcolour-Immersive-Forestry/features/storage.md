# thedarkcolour-Immersive-Forestry — storage
...
## Summary
Module `storage` in `thedarkcolour-Immersive-Forestry` is rooted at `src/main/java/forestry/storage` (29 Java sources). This annotated inventory covers its surface, layout, contracts, assets hooks, and Re-Forestry port relevance.
...
- `package-info`
- `BackpackInventory`
- `PagedBackpackInventory`
- `package-info`
- `BackpackItem`
- `ItemCrated`
- `NaturalistBackpackItem`
- `package-info`
- `package-info`

## Architecture
- Graph follow-up: `python3 tools/graphify_query.py IF "storage"`
...
- Declaration skim (first files):
  - `src/main/java/forestry/storage/BackpackDefinition.java`
    ...
    - L12: public class BackpackDefinition implements IBackpackDefinition {
    - L17: public BackpackDefinition(int primaryColor, int secondaryColor, Predicate<ItemStack> filter) {
    - L23: @Override
    - L24: public Predicate<ItemStack> getFilter() {
    - L28: @Override
    - L29: public Component getName(ItemStack backpack) {
    - L45: @Override
    - L46: public int getPrimaryColour() {
    - L50: @Override
    - L51: public int getSecondaryColour() {
  ...
  - `src/main/java/forestry/storage/BackpackInterface.java`
    - L1: package forestry.storage;
    - L19: public class BackpackInterface implements IBackpackInterface {
    - L20: @Override
    - L21: public Item createBackpack(IBackpackDefinition definition, EnumBackpackType type) {
    - L31: @Override
    - L32: public Item createNaturalistBackpack(IBackpackDefinition definition, ResourceLocation speciesTypeId, CreativeModeTab tab) {
    - L41: @Override
    - L42: public Predicate<ItemStack> createNaturalistBackpackFilter(ResourceLocation speciesRootUid) {
  ...
  - `src/main/java/forestry/storage/BackpackResupplyHandler.java`
    - L1: package forestry.storage;
    - L17: public class BackpackResupplyHandler {
    - L28: public static void resupply(Player player) {
  - `src/main/java/forestry/storage/ModuleStorage.java`
    - L1: package forestry.storage;
    - L22: @ForestryModule
    - L23: public class ModuleStorage extends BlankForestryModule {
    - L24: public static final IBackpackInterface BACKPACK_INTERFACE = new BackpackInterface();
    - L26: public static final BackpackDefinition APIARIST = new BackpackDefinition(0xc4923d, ForestryColors.WHITE, BACKPACK_INTERFACE.createNaturalistBackpackFilter(ForestrySpeciesTypes.BEE));
    - L27: public static final BackpackDefinition ARBORIST = new BackpackDefinition(0x657e3a, ForestryColors.WHITE, BACKPACK_INTERFACE.createNaturalistBackpackFilter(ForestrySpeciesTypes.TREE));
    - L28: public static final BackpackDefinition LEPIDOPTERIST = new BackpackDefinition(0x995b31, ForestryColors.WHITE, BACKPACK_INTERFACE.createNaturalistBackpackFilter(ForestrySpeciesTypes.BUTTERFLY));
    - L29: public static final BackpackDefinition MINER = new BackpackDefinition(0x36187d, ForestryColors.WHITE, new BackpackFilter(ForestryTags.Items.MINER_ALLOW, ForestryTags.Items.MINER_REJECT));
    - L30: public static final BackpackDefinition DIGGER = new BackpackDefinition(0x363cc5, ForestryColors.WHITE, new BackpackFilter(ForestryTags.Items.DIGGER_ALLOW, ForestryTags.Items.DIGGER_REJECT));
    - L31: public static final BackpackDefinition FORESTER = new BackpackDefinition(0x347427, ForestryColors.WHITE, new BackpackFilter(ForestryTags.Items.FORESTER_ALLOW, ForestryTags.Items.FORESTER_REJECT));
    - L32: public static final BackpackDefinition HUNTER = new BackpackDefinition(0x412215, ForestryColors.WHITE, new BackpackFilter(ForestryTags.Items.HUNTER_ALLOW, ForestryTags.Items.HUNTER_REJECT));
    - L33: public static final BackpackDefinition ADVENTURER = new BackpackDefinition(0x7fb8c2, ForestryColors.WHITE, new BackpackFilter(ForestryTags.Items.ADVENTURER_ALLOW, ForestryTags.Items.ADVENTURER_REJECT));
  ...
  - `src/main/java/forestry/storage/client/StorageClientHandler.java`
    - L1: package forestry.storage.client;
    - L24: public class StorageClientHandler implements IClientModuleHandler {
    - L29: public static final ModelResourceLocation FILLED_CRATE_MODEL = ModelResourceLocation.standalone(ForestryConstants.forestry("item/filled_crate"));
    - L31: @Override
    - L32: public void registerEvents(IEventBus modBus) {
    - L40: @SuppressWarnings("deprecation")
...
- `src/main/java/forestry/storage/inventory/BackpackInventory.java`
- `src/main/java/forestry/storage/inventory/PagedBackpackInventory.java`
- `src/main/java/forestry/storage/inventory/package-info.java`
- `src/main/java/forestry/storage/items/BackpackItem.java`
- `src/main/java/forestry/storage/items/ItemCrated.java`
- `src/main/java/forestry/storage/items/NaturalistBackpackItem.java`
