...
| Mail | `mail` | `mail` | Postal system — **Re-Forestry will not port** ([`mail-dropped.md`](mail-dropped.md)) |
...
**Re-Forestry:** this module is **out of scope** — [`mail-dropped.md`](mail-dropped.md).
...
### Mostly same
Factory staples, alveary, farms/planters, butterfly+moth counts, charcoal, backpacks (core six), bee housing loop. (CE mail trio exists in both Forestry versions; Re-Forestry does not port it.)
