...
> **STALE (2026-07-26).** Alveary, wild hives, scoop/smoker, frames, armor, and work gating are **done**.  
> Use [`queries/module-completeness-audit.md`](module-completeness-audit.md) (Apiculture section) and [`files/implemented-features.md`](../files/implemented-features.md) Phase 4 for current status. Remaining gaps: DummyBeeEffect leftovers, jubilance/specialties, breeding-tracker wiring, wax blocks, bee_chest, escritoire/discovery UI.

**Date:** 2026-07-24 (superseded)  
...
*(Those outdoor/upgrade items have since landed — see audit linked above.)*
