...
Last updated: 2026-08-21 (GD2: mutagen/protein/DNA recipes + caches. Next: GD3)
...
**Next up: Wave 7 `GD3`.** Gendustry GD2 recipes landed (mutagen / protein / DNA types + caches + 21 datapack recipes). Locked remaining order: see `queries/wave7-plan.md` (GD2 → GD3…). No solar/combustion.

**Wave 7 addons:** GD0 + EB1 + GD1 + GD2 done; Extra Trees still extract-only until ET1a.
...
| 3 | Addons | Gendustry → Extra Bees → Extra Trees | Config modules; **GD0 + EB1 + GD1 + GD2 done**. Next: **GD3** |
