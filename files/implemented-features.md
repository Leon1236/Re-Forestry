...
Last updated: 2026-08-21 (GD4: sampler + gene sample/template. Next: GD5)
...
**Next up: Wave 7 `GD5`.** Gendustry GD4 sampler + gene sample/template landed. Locked remaining order: see `queries/wave7-plan.md` (GD4 → GD5…). No solar/combustion.

**Wave 7 addons:** GD0 + EB1 + GD1 + GD2 + GD3 + GD4 done; Extra Trees still extract-only until ET1a.
...
| 3 | Addons | Gendustry → Extra Bees → Extra Trees | Config modules; **GD0 + EB1 + GD1 + GD2 + GD3 + GD4 done**. Next: **GD5** |
