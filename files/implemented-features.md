...
Last updated: 2026-08-21 (GD7b: industrial apiary upgrades. Next: GD8)
...
**Next up: Wave 7 `GD8`.** Gendustry GD7b industrial apiary upgrades landed. Locked remaining order: see `queries/wave7-plan.md` (GD7b → GD8…). No solar/combustion.

**Wave 7 addons:** GD0 + EB1 + GD1 + GD2 + GD3 + GD4 + GD5 + GD6 + GD7a + GD7b done; Extra Trees still extract-only until ET1a.
...
| 3 | Addons | Gendustry → Extra Bees → Extra Trees | Config modules; **GD0 + EB1 + GD1 + GD2 + GD3 + GD4 + GD5 + GD6 + GD7a + GD7b done**. Next: **GD8** |
