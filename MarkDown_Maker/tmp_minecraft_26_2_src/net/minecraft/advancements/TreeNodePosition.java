...
public class TreeNodePosition {
	...
	public TreeNodePosition(
		final AdvancementNode node, final @Nullable TreeNodePosition parent, final @Nullable TreeNodePosition previousSibling, final int childIndex, final int depth
	) {
