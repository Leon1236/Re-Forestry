...
public class ResourceKeyArgument<T> implements ArgumentType<ResourceKey<T>> {
	...
	private static <T> Holder.Reference<T> resolveKey(
		final CommandContext<CommandSourceStack> context, final String name, final ResourceKey<Registry<T>> registryKey, final DynamicCommandExceptionType exception
	) throws CommandSyntaxException {
