...
public class ReportPlayerScreen extends Screen {
	...
	protected void init() {
		...
		Button chatButton = this.layout
			.addChild(
				Button.builder(REPORT_CHAT, var1x -> this.minecraft.gui.setScreen(new ChatReportScreen(this.lastScreen, this.context, this.player.getPlayerId()))).build()
			);
		...
		this.layout
			.addChild(
				Button.builder(
						REPORT_SKIN,
						var1x -> this.minecraft.gui.setScreen(new SkinReportScreen(this.lastScreen, this.context, this.player.getPlayerId(), this.player.getSkinGetter()))
					)
					.build()
			);
		this.layout
			.addChild(
				Button.builder(
						REPORT_NAME,
						b -> this.minecraft.gui.setScreen(new NameReportScreen(this.lastScreen, this.context, this.player.getPlayerId(), this.player.getPlayerName()))
					)
					.build()
			);
