...
public class CreateWorldScreen extends Screen {
	...
	private LevelSettings createLevelSettings(final boolean isDebug) {
		...
		return isDebug
			? new LevelSettings(name, GameType.SPECTATOR, new LevelSettings.DifficultySettings(Difficulty.PEACEFUL, false, false), true, WorldDataConfiguration.DEFAULT)
			: new LevelSettings(
				name,
			...
			CreateWorldScreen.this.uiState
				.addListener(
					uiState -> this.nameEdit
						.setTooltip(
							Tooltip.create(Component.translatable("selectWorld.targetFolder", Component.literal(uiState.getTargetFolder()).withStyle(ChatFormatting.ITALIC)))
						)
				);
