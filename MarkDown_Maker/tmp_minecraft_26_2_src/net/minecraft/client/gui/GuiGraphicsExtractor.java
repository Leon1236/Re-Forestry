...
public class GuiGraphicsExtractor {
	 ...
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public final GuiGraphicsExtractor.ScissorStack scissorStack;
	...
	public void setTooltipForNextFrame(
		final Font font, final List<Component> texts, final Optional<TooltipComponent> optionalImage, final int xo, final int yo, final @Nullable Identifier style
	) {
