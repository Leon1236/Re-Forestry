...
public class SpecialModelRenderers {
	 ...
	 * Access widened by fabric-transitive-access-wideners-v1 to accessible
	 */
	public static final ExtraCodecs.LateBoundIdMapper<Identifier, MapCodec<? extends SpecialModelRenderer.Unbaked<?>>> ID_MAPPER = new ExtraCodecs.LateBoundIdMapper<>();
