...
public class AdvancementVisibilityEvaluator {
	...
	public static void evaluateVisibility(final AdvancementNode node, final Predicate<AdvancementNode> isDone, final AdvancementVisibilityEvaluator.Output output) {
