					...
					Commands.literal("feature")
						.then(
							Commands.argument("feature", ResourceKeyArgument.key(Registries.CONFIGURED_FEATURE))
								.executes(c -> placeFeature(c.getSource(), ResourceKeyArgument.getConfiguredFeature(c, "feature"), BlockPos.containing(c.getSource().getPosition())))
								.then(
									Commands.argument("pos", BlockPosArgument.blockPos())
										.executes(c -> placeFeature(c.getSource(), ResourceKeyArgument.getConfiguredFeature(c, "feature"), BlockPosArgument.getLoadedBlockPos(c, "pos")))
								)
						)
				)
				.then(
					...
					Commands.literal("structure")
						.then(
							Commands.argument("structure", ResourceKeyArgument.key(Registries.STRUCTURE))
								.executes(c -> placeStructure(c.getSource(), ResourceKeyArgument.getStructure(c, "structure"), BlockPos.containing(c.getSource().getPosition())))
								.then(
									Commands.argument("pos", BlockPosArgument.blockPos())
										.executes(c -> placeStructure(c.getSource(), ResourceKeyArgument.getStructure(c, "structure"), BlockPosArgument.getLoadedBlockPos(c, "pos")))
								)
						)
				)
				.then(
					Commands.literal("template")
						.then(
							Commands.argument("template", IdentifierArgument.id())
								...
								.executes(
									c -> placeTemplate(
										c.getSource(), IdentifierArgument.getId(c, "template"), BlockPos.containing(c.getSource().getPosition()), Rotation.NONE, Mirror.NONE, 1.0F, 0, false
									)
								)
								.then(
									Commands.argument("pos", BlockPosArgument.blockPos())
										.executes(
											c -> placeTemplate(
												c.getSource(), IdentifierArgument.getId(c, "template"), BlockPosArgument.getLoadedBlockPos(c, "pos"), Rotation.NONE, Mirror.NONE, 1.0F, 0, false
											)
										)
										.then(
