...
public class ExperienceCommand {
							...
							Commands.argument("target", EntityArgument.players())
								.then(
									Commands.argument("amount", IntegerArgumentType.integer())
										.executes(
											c -> addExperience(c.getSource(), EntityArgument.getPlayers(c, "target"), IntegerArgumentType.getInteger(c, "amount"), ExperienceCommand.Type.POINTS)
										)
										.then(
											Commands.literal("points")
												.executes(
													c -> addExperience(
														c.getSource(), EntityArgument.getPlayers(c, "target"), IntegerArgumentType.getInteger(c, "amount"), ExperienceCommand.Type.POINTS
													)
												)
										)
										.then(
											Commands.literal("levels")
												.executes(
													c -> addExperience(
														c.getSource(), EntityArgument.getPlayers(c, "target"), IntegerArgumentType.getInteger(c, "amount"), ExperienceCommand.Type.LEVELS
													)
												)
										)
								)
							...
							Commands.argument("target", EntityArgument.players())
								.then(
									Commands.argument("amount", IntegerArgumentType.integer(0))
										.executes(
											c -> setExperience(c.getSource(), EntityArgument.getPlayers(c, "target"), IntegerArgumentType.getInteger(c, "amount"), ExperienceCommand.Type.POINTS)
										)
										.then(
											Commands.literal("points")
												.executes(
					...
					Commands.literal("query")
						.then(
							Commands.argument("target", EntityArgument.player())
								.then(Commands.literal("points").executes(c -> queryExperience(c.getSource(), EntityArgument.getPlayer(c, "target"), ExperienceCommand.Type.POINTS)))
								.then(Commands.literal("levels").executes(c -> queryExperience(c.getSource(), EntityArgument.getPlayer(c, "target"), ExperienceCommand.Type.LEVELS)))
						)
				)
		);
	...
	private enum Type {
		...
		Type(final String name, final BiConsumer<ServerPlayer, Integer> add, final BiPredicate<ServerPlayer, Integer> set, final ToIntFunction<ServerPlayer> query) {
			this.add = add;
			this.name = name;
			this.set = set;
			this.query = query;
