...
public class HelpCommand {
	...
	public static void register(final CommandDispatcher<CommandSourceStack> dispatcher) {
		dispatcher.register(Commands.literal("help").executes(s -> {
			...
			Map<CommandNode<CommandSourceStack>, String> usage = dispatcher.getSmartUsage(Iterables.getLast(command.getContext().getNodes()).getNode(), s.getSource());
