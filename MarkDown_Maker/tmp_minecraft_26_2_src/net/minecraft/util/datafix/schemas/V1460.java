...
public class V1460 extends NamespacedSchema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
		...
		schema.register(
			map, "minecraft:donkey", name -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(schema)), "SaddleItem", References.ITEM_STACK.in(schema))
		);
		...
		schema.register(
			map, "minecraft:spawner_minecart", name -> DSL.optionalFields("DisplayState", References.BLOCK_STATE.in(schema), References.UNTAGGED_SPAWNER.in(schema))
		);
