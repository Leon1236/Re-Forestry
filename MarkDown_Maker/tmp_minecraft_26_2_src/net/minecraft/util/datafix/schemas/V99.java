...
public class V99 extends Schema {
	...
	public Map<String, Supplier<TypeTemplate>> registerEntities(final Schema schema) {
		...
		schema.register(
			map, "MinecartHopper", name -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "Items", DSL.list(References.ITEM_STACK.in(schema)))
		);
		schema.register(
			map, "MinecartCommandBlock", () -> DSL.optionalFields("DisplayTile", References.BLOCK_NAME.in(schema), "LastOutput", References.TEXT_COMPONENT.in(schema))
		);
