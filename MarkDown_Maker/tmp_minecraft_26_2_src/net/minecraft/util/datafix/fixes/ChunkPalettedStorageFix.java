							...
							case 25:
								for (int pos : entry.getValue()) {
									...
									if (entity != null) {
										...
										this.setBlock(
											pos,
											ChunkPalettedStorageFix.MappingConstants.NOTE_BLOCK_MAP.getOrDefault(key, ChunkPalettedStorageFix.MappingConstants.NOTE_BLOCK_MAP.get("false0"))
										);
									}
								}
								break;
									...
									if (ChunkPalettedStorageFix.getName(state).endsWith("_door")) {
										...
										if ("lower".equals(ChunkPalettedStorageFix.getProperty(lower, "half"))) {
											...
											if (name.equals(ChunkPalettedStorageFix.getName(upper))) {
												...
												this.setBlock(abovePos, ChunkPalettedStorageFix.MappingConstants.DOOR_MAP.get(name + facing + "upper" + hinge + open + powered));
											}
										}
									}
								}
							...
							case 144:
								for (int pos : entry.getValue()) {
									...
									if (entity != null) {
										...
										entity.remove("Rot");
										this.setBlock(
											pos, ChunkPalettedStorageFix.MappingConstants.SKULL_MAP.getOrDefault(key, ChunkPalettedStorageFix.MappingConstants.SKULL_MAP.get("0north"))
										);
									}
								}
								break;
