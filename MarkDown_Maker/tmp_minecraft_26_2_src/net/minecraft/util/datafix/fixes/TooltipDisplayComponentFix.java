...
public class TooltipDisplayComponentFix extends DataFix {
	...
	protected TypeRewriteRule makeRule() {
		...
		return this.fixTypeEverywhereTyped(
			"TooltipDisplayComponentFix", componentsType, newComponentsType, typed -> fix(typed, canPlaceOnFinder, canBreakFinder, newCanPlaceOnType, newCanBreakType)
		);
	}

	private static Typed<?> fix(
		Typed<?> typed, final OpticFinder<?> canPlaceOnFinder, final OpticFinder<?> canBreakFinder, final Type<?> newCanPlaceOnType, final Type<?> newCanBreakType
	) {
