...
public class TradeRebalanceVillagerTrades extends VillagerTrades {
	...
	public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
		...
		register(
			context, LIBRARIAN_1_EMERALD_AND_BOOK_SNOW_ENCHANTED_BOOK, createLibrarianLevel1EnchantmentTrade(items, doubleTradePrice, snowType, enchantmentsSnowCommon)
		);
		register(
			context,
		...
		register(
			context, LIBRARIAN_2_EMERALD_AND_BOOK_SNOW_ENCHANTED_BOOK, createLibrarianLevel2EnchantmentTrade(items, doubleTradePrice, snowType, enchantmentsSnowCommon)
		);
		register(
			context,
		...
		register(
			context, LIBRARIAN_3_EMERALD_AND_BOOK_SNOW_ENCHANTED_BOOK, createLibrarianLevel3EnchantmentTrade(items, doubleTradePrice, snowType, enchantmentsSnowCommon)
		);
		register(
			context,
		...
		register(
			...
			new VillagerTrade(
				...
				villagerTypeRestriction(
					villagerTypeHolderSet(villagerVariants, List.of(VillagerType.DESERT, VillagerType.PLAINS, VillagerType.SAVANNA, VillagerType.SNOW, VillagerType.TAIGA))
				),
				List.of()
			)
		);
