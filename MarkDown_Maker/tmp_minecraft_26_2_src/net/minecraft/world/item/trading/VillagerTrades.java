...
public class VillagerTrades {
	...
	public static Holder<VillagerTrade> bootstrap(final BootstrapContext<VillagerTrade> context) {
		...
		register(
			...
			new VillagerTrade(
				new TradeCost(Items.EMERALD, 3), new ItemStackTemplate(Items.LEATHER_LEGGINGS), 12, 1, 0.2F, Optional.empty(), dyedItem(items, Items.LEATHER_LEGGINGS)
			)
		);
		register(
			context,
			...
			new VillagerTrade(
				new TradeCost(Items.EMERALD, 7), new ItemStackTemplate(Items.LEATHER_CHESTPLATE), 12, 1, 0.2F, Optional.empty(), dyedItem(items, Items.LEATHER_CHESTPLATE)
			)
		);
		register(
			context,
	...
	private static void registerBoatTrades(final BootstrapContext<VillagerTrade> context, final HolderGetter<VillagerType> villagerVariants) {
		...
		register(
			context, FISHERMAN_5_JUNGLE_BOAT_EMERALD, createMasonBoatBuyTrade(villagerVariants, Items.JUNGLE_BOAT, List.of(VillagerType.DESERT, VillagerType.JUNGLE))
		);
