...
public enum VaultState implements StringRepresentable {
	...
	public void onTransition(
		final ServerLevel serverLevel, final BlockPos pos, final VaultState to, final VaultConfig config, final VaultSharedData sharedData, final boolean isOminous
	) {
