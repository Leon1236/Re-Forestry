...
public class BlockEntityTypes {
	...
	public static final BlockEntityType<ComparatorBlockEntity> COMPARATOR = register(BlockEntityTypeIds.COMPARATOR, ComparatorBlockEntity::new, Blocks.COMPARATOR);
