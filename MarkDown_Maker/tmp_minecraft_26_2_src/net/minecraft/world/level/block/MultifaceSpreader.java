...
public class MultifaceSpreader {
	...
	public boolean canSpreadInAnyDirection(final BlockState state, final BlockGetter level, final BlockPos pos, final Direction startingFace) {
		return Direction.stream()
			.anyMatch(spreadDirection -> this.getSpreadFromFaceTowardDirection(state, level, pos, startingFace, spreadDirection, this.config::canSpreadInto).isPresent());
	}
	...
	public Optional<MultifaceSpreader.SpreadPos> spreadFromFaceTowardDirection(
		final BlockState state, final LevelAccessor level, final BlockPos pos, final Direction fromFace, final Direction spreadDirection, final boolean postProcess
	) {
