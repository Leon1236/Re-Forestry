...
public class BoundingBox {
	...
	public static BoundingBox encapsulating(final BoundingBox a, final BoundingBox b) {
		return new BoundingBox(
			Math.min(a.minX, b.minX), Math.min(a.minY, b.minY), Math.min(a.minZ, b.minZ), Math.max(a.maxX, b.maxX), Math.max(a.maxY, b.maxY), Math.max(a.maxZ, b.maxZ)
		);
	}
	...
	public boolean equals(final Object o) {
		if (this == o) {
			...
			return !(o instanceof BoundingBox that)
				? false
				: this.minX == that.minX && this.minY == that.minY && this.minZ == that.minZ && this.maxX == that.maxX && this.maxY == that.maxY && this.maxZ == that.maxZ;
		}
	}
