...
public class NetherFossilPieces {
	...
	public static void addPieces(
		...
		structurePieceAccessor.addPiece(new NetherFossilPieces.NetherFossilPiece(structureTemplateManager, Util.getRandom(FOSSILS, random), position, nextRotation));
	}
	...
	public static class NetherFossilPiece extends TemplateStructurePiece {
		...
		public NetherFossilPiece(final StructureTemplateManager structureTemplateManager, final CompoundTag tag) {
			super(StructurePieceType.NETHER_FOSSIL, tag, structureTemplateManager, location -> makeSettings(tag.read("Rot", Rotation.LEGACY_CODEC).orElseThrow()));
		}
