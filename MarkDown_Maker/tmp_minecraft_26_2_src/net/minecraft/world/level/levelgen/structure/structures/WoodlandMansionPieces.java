...
public class WoodlandMansionPieces {
	...
	private static class MansionGrid {
		...
		public @Nullable Direction get1x2RoomDirection(final WoodlandMansionPieces.SimpleGrid grid, final int x, final int y, final int floorNum, final int roomId) {
	...
	private static class MansionPiecePlacer {
					...
					for (int x = 0; x < grid.width; x++) {
						if (grid.get(x, y) == 1) {
							...
							if (grid.get(x, y + 1) == 1 || (rooms.get(x, y + 1) & 8388608) == 8388608) {
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureTemplateManager, southPiece, pos.relative(rotation.rotate(Direction.SOUTH), 5).relative(rotation.rotate(Direction.WEST), 1), rotation
									)
								);
							}
							...
							if (grid.get(x - 1, y) == 1 || (rooms.get(x - 1, y) & 8388608) == 8388608) {
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureTemplateManager, westPiece, pos.relative(rotation.rotate(Direction.WEST), 1).relative(rotation.rotate(Direction.NORTH), 1), rotation
									)
								);
							}
						}
					...
					for (int x = 0; x < grid.width; x++) {
						...
						if (grid.get(x, y) == 2 || thirdFloorStartRoom) {
							...
							if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y) && !mansion.isRoomId(grid, x - 1, y, floorNum, roomId)) {
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, doorDir == Direction.WEST ? doorPiece : wallPiece, roomPos, rotation)
								);
							}
							...
							if (grid.get(x + 1, y) == 1 && !thirdFloorStartRoom) {
								...
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, doorDir == Direction.EAST ? doorPiece : wallPiece, pos, rotation)
								);
							}
							...
							if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1) && !mansion.isRoomId(grid, x, y + 1, floorNum, roomId)) {
								...
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureTemplateManager, doorDir == Direction.SOUTH ? doorPiece : wallPiece, pos, rotation.getRotated(Rotation.CLOCKWISE_90)
									)
								);
							}
							...
							if (grid.get(x, y - 1) == 1 && !thirdFloorStartRoom) {
								...
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(
										this.structureTemplateManager, doorDir == Direction.NORTH ? doorPiece : wallPiece, pos, rotation.getRotated(Rotation.CLOCKWISE_90)
									)
								);
							}
				...
				for (int x = 0; x < grid.width; x++) {
					...
					if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y) && !isAbove) {
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y)) {
							...
							pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_front", p2, rotation.getRotated(Rotation.CLOCKWISE_180)));
						}

						if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y - 1)) {
							BlockPos p2 = position.relative(rotation.rotate(Direction.WEST), 1);
							pieces.add(
								new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_front", p2, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
							);
						}
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1)) {
							...
							pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_front", p2, rotation.getRotated(Rotation.CLOCKWISE_90)));
						}
					}
				}
			}
					...
					for (int x = 0; x < grid.width; x++) {
						...
						if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y) && isAbove) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y)) {
								BlockPos p2 = position.relative(rotation.rotate(Direction.WEST), 1);
								p2 = p2.relative(rotation.rotate(Direction.SOUTH), 6);
								pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall", p2, rotation.getRotated(Rotation.CLOCKWISE_180)));
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y - 1)) {
								...
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall", p2, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
								);
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1)) {
								BlockPos p2 = position.relative(rotation.rotate(Direction.EAST), 6);
								p2 = p2.relative(rotation.rotate(Direction.SOUTH), 7);
								pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall", p2, rotation.getRotated(Rotation.CLOCKWISE_90)));
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x + 1, y)) {
								...
								if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1)) {
									...
									p2 = p2.relative(rotation.rotate(Direction.SOUTH), 7);
									pieces.add(
										new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", p2, rotation.getRotated(Rotation.CLOCKWISE_90))
									);
								}
							}
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y)) {
								...
								if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1)) {
									...
									pieces.add(
										new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "small_wall_corner", p2, rotation.getRotated(Rotation.CLOCKWISE_180))
									);
								}
							}
						}
				...
				for (int x = 0; x < grid.width; x++) {
					...
					if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y) && !isAbove) {
						if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x + 1, y)) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y - 1)) {
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", p2, rotation.getRotated(Rotation.COUNTERCLOCKWISE_90))
								);
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x + 1, y - 1)) {
								BlockPos p3 = position.relative(rotation.rotate(Direction.EAST), 9);
								p3 = p3.relative(rotation.rotate(Direction.NORTH), 2);
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", p3, rotation.getRotated(Rotation.CLOCKWISE_90))
								);
							}
						}
						...
						if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y)) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y + 1)) {
								BlockPos p3 = p2.relative(rotation.rotate(Direction.SOUTH), 6);
								pieces.add(new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", p3, rotation.getRotated(Rotation.CLOCKWISE_90)));
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y + 1)) {
							...
							if (!WoodlandMansionPieces.MansionGrid.isHouse(grid, x, y - 1)) {
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_corner", p2, rotation.getRotated(Rotation.CLOCKWISE_180))
								);
							} else if (WoodlandMansionPieces.MansionGrid.isHouse(grid, x - 1, y - 1)) {
								BlockPos p3 = p2.relative(rotation.rotate(Direction.SOUTH), 1);
								pieces.add(
									new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, "roof_inner_corner", p3, rotation.getRotated(Rotation.CLOCKWISE_180))
								);
							}
						}
					}
		...
		private void addRoom1x2(
			...
			if (doorDir == Direction.EAST && roomDir == Direction.SOUTH) {
				...
				pieces.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureTemplateManager, rooms.get1x2SideEntrance(this.random, isStairsRoom), pos, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.LEFT_RIGHT
					)
				);
				...
				pieces.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(
						this.structureTemplateManager, rooms.get1x2SideEntrance(this.random, isStairsRoom), pos, rotation.getRotated(Rotation.CLOCKWISE_90), Mirror.FRONT_BACK
					)
				);
				...
				pieces.add(
					new WoodlandMansionPieces.WoodlandMansionPiece(this.structureTemplateManager, rooms.get1x2FrontEntrance(this.random, isStairsRoom), pos, rotation)
				);
	...
	public static class WoodlandMansionPiece extends TemplateStructurePiece {
		...
		public WoodlandMansionPiece(
			final StructureTemplateManager structureTemplateManager, final String templateName, final BlockPos position, final Rotation rotation, final Mirror mirror
		) {
			super(
				StructurePieceType.WOODLAND_MANSION_PIECE, 0, structureTemplateManager, makeLocation(templateName), templateName, makeSettings(mirror, rotation), position
			);
		}
