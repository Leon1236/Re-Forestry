...
public abstract class TrunkPlacer {
	...
	protected static void placeBelowTrunkBlock(
		final WorldGenLevel level, final BiConsumer<BlockPos, BlockState> trunkSetter, final RandomSource random, final BlockPos pos, final TreeConfiguration config
	) {
