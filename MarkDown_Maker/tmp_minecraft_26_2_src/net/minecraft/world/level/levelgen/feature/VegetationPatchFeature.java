...
public class VegetationPatchFeature extends Feature<VegetationPatchConfiguration> {
	...
	protected boolean placeVegetation(
		final WorldGenLevel level, final VegetationPatchConfiguration config, final ChunkGenerator generator, final RandomSource random, final BlockPos vegetationPos
	) {
