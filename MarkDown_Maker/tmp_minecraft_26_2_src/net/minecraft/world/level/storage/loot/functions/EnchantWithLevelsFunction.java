...
public class EnchantWithLevelsFunction extends LootItemConditionalFunction {
	...
	public static EnchantWithLevelsFunction.Builder enchantWithLevels(final HolderLookup.Provider registries, final NumberProvider levels) {
		return new EnchantWithLevelsFunction.Builder(levels).withOptions(registries.lookupOrThrow(Registries.ENCHANTMENT).getOrThrow(EnchantmentTags.ON_RANDOM_LOOT));
	}
