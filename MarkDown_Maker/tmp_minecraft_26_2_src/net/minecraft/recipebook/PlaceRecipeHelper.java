...
public interface PlaceRecipeHelper {
	...
	static <T> void placeRecipe(
		final int gridWidth, final int gridHeight, final int recipeWidth, final int recipeHeight, final Iterable<T> entries, final PlaceRecipeHelper.Output<T> output
	) {
