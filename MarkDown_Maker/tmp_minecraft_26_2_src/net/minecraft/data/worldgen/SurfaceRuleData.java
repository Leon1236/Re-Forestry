...
public class SurfaceRuleData {
	...
	public static SurfaceRules.RuleSource overworldLike(
		...
		SurfaceRules.RuleSource biomeSurfaceRule = SurfaceRules.sequence(
			...
			SurfaceRules.ifTrue(
				SurfaceRules.isBiome(biomes, Biomes.JAGGED_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(steep, STONE), SurfaceRules.ifTrue(aboveWater, SNOW_BLOCK))
			),
			SurfaceRules.ifTrue(SurfaceRules.isBiome(biomes, Biomes.GROVE), SurfaceRules.sequence(powderSnowSurfaceRule, SurfaceRules.ifTrue(aboveWater, SNOW_BLOCK))),
			commonSurfaceAndUnderRules,
			SurfaceRules.ifTrue(
			...
			SurfaceRules.ifTrue(
				...
				SurfaceRules.ifTrue(
					...
					SurfaceRules.sequence(
						SurfaceRules.ifTrue(
							frozenOcean,
							SurfaceRules.ifTrue(hole, SurfaceRules.sequence(SurfaceRules.ifTrue(aboveWater, AIR), SurfaceRules.ifTrue(SurfaceRules.temperature(), ICE), WATER))
						),
						biomeSurfaceRule
					)
				)
				...
				SurfaceRules.sequence(
					SurfaceRules.ifTrue(
						...
						SurfaceRules.ifTrue(
							...
							SurfaceRules.sequence(
								SurfaceRules.ifTrue(
									SurfaceRules.not(hole), SurfaceRules.ifTrue(netherBandAroundLavaLevelBottom, SurfaceRules.ifTrue(netherBandAroundLavaLevelTop, SOUL_SAND))
								),
								NETHERRACK
							)
						)
					...
					SurfaceRules.ifTrue(
						...
						SurfaceRules.ifTrue(
							...
							SurfaceRules.ifTrue(
								...
								SurfaceRules.ifTrue(
									gravelLayer, SurfaceRules.sequence(SurfaceRules.ifTrue(aboveNetherLavaSurface, GRAVEL), SurfaceRules.ifTrue(SurfaceRules.not(hole), GRAVEL))
								)
							)
						)
					)
