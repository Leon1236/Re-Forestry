	...
	public static void bootstrap(final BootstrapContext<ConfiguredFeature<?, ?>> context) {
		...
		FeatureUtils.register(
			...
			new TreeConfiguration.TreeConfigurationBuilder(
					...
					new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5F, UniformInt.of(0, 1), blocks.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)),
		...
		FeatureUtils.register(
			...
			new TreeConfiguration.TreeConfigurationBuilder(
					BlockStateProvider.simple(Blocks.MANGROVE_LOG),
					new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5F, UniformInt.of(0, 1), blocks.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)),
					BlockStateProvider.simple(Blocks.MANGROVE_LEAVES),
					new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70),
					Optional.of(
						new MangroveRootPlacer(
		...
		FeatureUtils.register(
			context, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, createOak(belowTrunkProvider).decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build()
		);
