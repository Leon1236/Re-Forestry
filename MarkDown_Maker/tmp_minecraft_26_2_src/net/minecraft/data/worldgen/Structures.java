			...
			new SwampHutStructure(
				new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_SWAMP_HUT))
					.spawnOverrides(
						Map.of(
							MobCategory.MONSTER,
							new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.WITCH, 1, 1))),
							MobCategory.CREATURE,
							new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of(new MobSpawnSettings.SpawnerData(EntityTypes.CAT, 1, 1)))
						)
					)
					.build()
			)
				...
				new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_ANCIENT_CITY))
					.spawnOverrides(
						Arrays.stream(MobCategory.values())
							.collect(Collectors.toMap(c -> (MobCategory)c, c -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.STRUCTURE, WeightedList.of())))
					)
					.generationStep(GenerationStep.Decoration.UNDERGROUND_DECORATION)
		...
		context.register(
			...
			new JigsawStructure(
				new Structure.StructureSettings.Builder(biomes.getOrThrow(BiomeTags.HAS_TRIAL_CHAMBERS))
					...
					.spawnOverrides(
						Arrays.stream(MobCategory.values())
							.collect(Collectors.toMap(c -> (MobCategory)c, c -> new StructureSpawnOverride(StructureSpawnOverride.BoundingBoxType.PIECE, WeightedList.of())))
					)
					.build(),
