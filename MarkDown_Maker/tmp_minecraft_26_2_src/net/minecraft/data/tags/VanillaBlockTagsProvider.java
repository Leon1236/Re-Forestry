...
public class VanillaBlockTagsProvider extends TagsProvider<Block> {
	...
	protected void addTags(final HolderLookup.Provider registries) {
		...
		this.tag(BlockTags.CORALS)
			...
			.add(BlockItemIds.TUBE_CORAL_FAN, BlockItemIds.BRAIN_CORAL_FAN, BlockItemIds.BUBBLE_CORAL_FAN, BlockItemIds.FIRE_CORAL_FAN, BlockItemIds.HORN_CORAL_FAN);
		this.tag(BlockTags.WALL_CORALS)
			.add(BlockIds.TUBE_CORAL_WALL_FAN, BlockIds.BRAIN_CORAL_WALL_FAN, BlockIds.BUBBLE_CORAL_WALL_FAN, BlockIds.FIRE_CORAL_WALL_FAN, BlockIds.HORN_CORAL_WALL_FAN);
		...
		this.tag(BlockTags.DRAGON_IMMUNE)
			...
			.add(BlockItemIds.COMMAND_BLOCK, BlockItemIds.REPEATING_COMMAND_BLOCK, BlockItemIds.CHAIN_COMMAND_BLOCK, BlockItemIds.STRUCTURE_BLOCK, BlockItemIds.JIGSAW)
		...
		this.tag(BlockTags.SWORD_EFFICIENT)
			...
			.add(BlockItemIds.PUMPKIN, BlockItemIds.CARVED_PUMPKIN, BlockItemIds.JACK_O_LANTERN, BlockItemIds.MELON, BlockItemIds.COCOA_CROP, BlockItemIds.BIG_DRIPLEAF)
			.add(BlockIds.BIG_DRIPLEAF_STEM)
		...
		this.tag(BlockTags.REPLACEABLE)
			.addAll(registries.lookupOrThrow(Registries.BLOCK).listElements().filter(b -> b.value().defaultBlockState().canBeReplaced()).map(Holder.Reference::key));
