...
public class VanillaItemTagsProvider extends TagsProvider<Item> {
	...
	protected void addTags(final HolderLookup.Provider registries) {
		...
		this.tag(ItemTags.SPEARS)
			.add(
				ItemIds.DIAMOND_SPEAR, ItemIds.STONE_SPEAR, ItemIds.GOLDEN_SPEAR, ItemIds.NETHERITE_SPEAR, ItemIds.WOODEN_SPEAR, ItemIds.IRON_SPEAR, ItemIds.COPPER_SPEAR
			);
		...
		this.tag(ItemTags.CAULDRON_CAN_REMOVE_DYE)
			.add(ItemIds.LEATHER_HELMET, ItemIds.LEATHER_CHESTPLATE, ItemIds.LEATHER_LEGGINGS, ItemIds.LEATHER_BOOTS, ItemIds.LEATHER_HORSE_ARMOR, ItemIds.WOLF_ARMOR);
		...
		this.tag(ItemTags.SULFUR_CUBE_ARCHETYPE_SLOW_BOUNCY)
			...
			.add(BlockItemIds.CRIMSON_NYLIUM, BlockItemIds.CRYING_OBSIDIAN, BlockItemIds.CUT_RED_SANDSTONE, BlockItemIds.CUT_SANDSTONE, BlockItemIds.DARK_PRISMARINE)
			...
			.add(BlockItemIds.SMOOTH_BASALT, BlockItemIds.SMOOTH_QUARTZ, BlockItemIds.SMOOTH_RED_SANDSTONE, BlockItemIds.SMOOTH_SANDSTONE, BlockItemIds.SMOOTH_STONE)
			.add(
				BlockItemIds.STONE,
