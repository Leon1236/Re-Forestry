									...
									.when(
										LootItemEntityPropertyCondition.hasProperties(
											...
											EntityPredicate.Builder.entity()
												.components(DataComponentExactPredicate.expect(DataComponents.CHICKEN_VARIANT, chickenVariants.getOrThrow(ChickenVariants.TEMPERATE)))
										)
									),
								LootItem.lootTableItem(Items.BROWN_EGG)
									.when(
										LootItemEntityPropertyCondition.hasProperties(
											LootContext.EntityTarget.THIS,
											EntityPredicate.Builder.entity()
												.components(DataComponentExactPredicate.expect(DataComponents.CHICKEN_VARIANT, chickenVariants.getOrThrow(ChickenVariants.WARM)))
										)
									),
								LootItem.lootTableItem(Items.BLUE_EGG)
									.when(
										LootItemEntityPropertyCondition.hasProperties(
											LootContext.EntityTarget.THIS,
											EntityPredicate.Builder.entity()
												.components(DataComponentExactPredicate.expect(DataComponents.CHICKEN_VARIANT, chickenVariants.getOrThrow(ChickenVariants.COLD)))
										)
									)
							)
						)
