					...
					LootPool.lootPool()
						...
						.add(
							LootItem.lootTableItem(Items.MUSIC_DISC_BOUNCE)
								.when(LocationCheck.checkLocation(LocationPredicate.Builder.location().setBiomes(HolderSet.direct(biomes.getOrThrow(Biomes.SULFUR_CAVES)))))
								.setWeight(10)
						)
				)
		);
			...
			LootTable.lootTable()
				.withPool(
					LootPool.lootPool()
						...
						.add(LootItem.lootTableItem(Blocks.WOOL.lightGray()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
						.add(LootItem.lootTableItem(Items.EMERALD).setWeight(1))
				...
				.withPool(
					LootPool.lootPool()
						...
						.add(
							LootItem.lootTableItem(Items.BOOK)
								.setWeight(2)
								.apply(new SetEnchantmentsFunction.Builder().withEnchantment(enchantments.getOrThrow(Enchantments.WIND_BURST), ConstantValue.exactly(1.0F)))
						)
